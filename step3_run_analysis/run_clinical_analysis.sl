...
#SBATCH --array=0-24
###################################################################################
# ^ UPDATE THE ARRAY RANGE MANUALLY; IT SHOULD BE THE PRODUCT OF THE NUMBER OF  ^ #
# ^ STUDY, MODEL, AND DATA CONFIGURATION, MINUS 1                               ^ #
###################################################################################

# Fill these in manually before running the SLURM script!
N_DATASETS=5
N_MODELS=5
STUDY_FOLDER="./study_config"
MODEL_FOLDER="./model_configs"
DATA_FOLDER="../step2_prep_data/b_dataset_gen/datasets/clinical/configs"
...
source activate modular_optuna_ml
